                        ...
                        <section className="w-30"
                            ...
                            <div className="card ma-16">
                                ...
                                {product.cartQuantity===0 ?
                                    <button className="x-small outlined" data-testid="btn-item-add" onClick={()=>{this.props.add(product.id - 1);}}>
                                        Add To Cart
                                    </button>
                                    
                                    :
                                    <button className="x-small danger" data-testid="btn-item-remove" onClick={()=>{this.props.rem(product.id - 1);}}>
                                        Remove
                                    </button>
